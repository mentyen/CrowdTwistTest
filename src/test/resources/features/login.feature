Feature: TC001 Validating a Sign in functionality
  ...
  Scenario Outline: Validating sign in functionality
    ...
    Examples: 
      | firstName | lastName | password | address             | city     | state    | zip   | country       | phone      |
      | Bob       | White    | password | 30-30 Morris street | Brooklyn | New York | 10233 | United States | 4456789898 |
